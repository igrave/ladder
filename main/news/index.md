...
- Fix transparent font highlighting in flextable
- Fix transparent borders in flextable, these are now defined as having
  width 1 EMU, effectively invisible.
...
- Implement slide picker to select and authorise presentation for use
  with ladder
