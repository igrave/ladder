...
For more powerful formatting, use
...
You can directly preview the slides with `view_slide(slides_id)` or get
a link with `get_link(slides_id)`.
...
As far as I know these are limitations of the Slides platform/API and
flextable. Let me know if you find something different.

### Not possible in Slides

- images in tables
- changes to cell padding
  - May be possible to set ParagraphSyle IndentStart to a negative
    value?
