...
Authorize ladder to view and manage your presentations. This function is
a wrapper around
...
Google account, and to grant ladder permission to operate on your behalf
with Google Slides. By default, with your permission, these user
